...
function BottomNavigation({ onPress }) {
  return (
    <View
      style={{
        flexDirection: "row",
    ...
    >
      ...
      >
        <Image
          ...
          style={{ width: 30, height: 30 }}
        />
        <Text style={{ fontSize: 10 }}>Add Doctor</Text>
      </TouchableOpacity>
      <TouchableOpacity
        onPress={onPress.helpline}
        style={{
          width: "25%",
          justifyContent: "center",
          alignItems: "center",
        ...
        >
          ...
          >
            <View style={{ paddingLeft: 5 }}>
              <TouchableOpacity onPress={onPress.viewAll}>
                <View
                  style={{
                    alignItems: "center",
                    justifyContent: "center",
            ...
            <View style={{ paddingLeft: 5 }}>
              <TouchableOpacity onPress={onPress.myDoctors}>
                <View
                  style={{
                    alignItems: "center",
                    justifyContent: "center",
  ...
  return (
    <SafeAreaView style={{ height: "100%", backgroundColor: "white" }}>
      ...
      >
        ...
        <Search onPress={() => navigation.navigate("View All")} />
        <MyAppointments
          onAppointmentsClick={() => {
            navigation.navigate("My Appointments");
          }}
        ...
        <Help
          onPress={{
            myDoctors: () => navigation.navigate("My Doctors"),
            myProfile: () => navigation.navigate("My Profile"),
            viewAll: () =>
              navigation.navigate("Symptoms", {
                symptomData: { name: "In-Clinic Doctors" },
              }),
          }}
        />
        <Symptoms navigation={navigation} />
        <Diseases navigation={navigation} />
      </ScrollView>
      <BottomNavigation
        onPress={{
          helpline: () => navigation.navigate("Contact Us"),
          appointments: () => navigation.navigate("My Appointments"),
          addDoctor: () =>
            navigation.navigate("Symptoms", {
